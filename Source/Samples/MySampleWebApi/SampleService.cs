...
public class SampleService : ISampleService
{
	...
	public void Run()
	{
		...
		_logger.LogInformation($"DbConnectionString					: {_config["ConnectionStrings:XformConnectionString"]}");
		...
		Console.WriteLine($"DbConnectionString						: {_config["ConnectionStrings:XformConnectionString"]}");
