...
/// </summary>
public static class WinFormsAppBuilder
{
	#region - Public Methods -

	/// <summary>
	/// Builds and returns a HostApplicationBuilder for a WinForms application.
	/// </summary>
	/// <param name="hostBuilder"></param>
	/// <param name="appOptions"></param>
	/// <returns></returns>
	public static HostApplicationBuilder CreateHostBuilder(WinFormsAppOptions appOptions)
	{
	...
	/// <summary>
	/// Builds and returns IHost for a WinForms application.
	/// </summary>
	/// <param name="hostBuilder"></param>
	/// <param name="appOptions"></param>
	/// <returns></returns>
	public static IHost CreateHost(WinFormsAppOptions appOptions)
	{
